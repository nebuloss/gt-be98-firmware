...
| [docs/host-deps-arch.md](docs/host-deps-arch.md) | Paquets hôte pour le build (Arch / Debian) |
| [patches/README.md](patches/README.md) | **26** patches GCC 10 / TI-RPC / toolchain native + fonctionnels (0001–0023 build, 0024–0026 fonctionnels, 0013b) |
