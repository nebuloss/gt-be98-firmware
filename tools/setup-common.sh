...
# GT-BE98 platform tree (not the empty router-sysdep/ stub).
GTBE98_SYSDEP="${GTBE98_SYSDEP:-router-sysdep.gt-be98}"
GTBE98_CJSON_DIR="${GTBE98_CJSON_DIR:-${GTBE98_SDK_DIR}/${GTBE98_SYSDEP}/cjson}"
